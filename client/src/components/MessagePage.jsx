...
import { IoIosArrowBack, IoClose, IoSend } from "react-icons/io5";
  ...
  return (
    <div style={{ backgroundImage: `url(${backImage})` }} className="bg-no-repeat bg-cover flex flex-col h-screen">
      ...
      <section className='h-[calc(100vh-160px)] overflow-x-hidden overflow-y-scroll scrollbar relative bg-slate-200 bg-opacity-50'>
        ...
        {message.imageUrl && (
          <div className='fixed bottom-0 left-0 right-0 top-0 bg-slate-700 bg-opacity-30 flex justify-center items-center rounded overflow-hidden'>
            <div className='w-fit absolute top-0 right-0 p-3 cursor-pointer hover:text-red-500' onClick={handleCloseUploadImage}>
              <IoClose size={30} />
            </div>
            <div className='bg-white p-3 max-h-full overflow-y-auto'>
              <img
            ...
            <div className='bg-white shadow rounded absolute bottom-16 w-40 p-2'>
              <form>
                <label htmlFor='uploadImage' className='flex items-center p-2 gap-3 hover:bg-slate-200 px-3 cursor-pointer text-xl'>
                  ...
                  <input type='file' id='uploadImage' hidden onChange={handleUploadImage} />
                </label>
                <label htmlFor='uploadVideo' className='flex items-center p-2 gap-3 hover:bg-slate-200 px-3 cursor-pointer text-xl'>
                  ...
                  <input type='file' id='uploadVideo' hidden onChange={handleUploadVideo} />
                </label>
              </form>
            </div>
          )}
        </div>
        <form className='flex flex-grow ml-3 relative' onSubmit={handleSendMessage}>
          <input
          ...
          />
          <button type='submit' className='flex justify-center items-center w-11 h-11 rounded-full hover:bg-primary hover:text-white absolute right-2'>
            <IoSend size={20} />
          </button>
        </form>
      </section>
