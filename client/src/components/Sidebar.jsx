...
export const Sidebar = () => {
    ...
    return (
        <div className='h-full flex'>
            <div className="bg-slate-100 w-16 h-full py-4 flex flex-col justify-between fixed z-10">
                <div>
                ...
                <div className="flex flex-col items-center">
                    <button className='mx-auto my-3' title={user.name} onClick={() => setEditUserOpen(true)}>
                        <Profile
                            width={50}
                            height={50}
                            name={user?.name}
                    ...
                    <button title="logout" className="w-10 h-10 my-3 flex justify-center items-center cursor-pointer hover:bg-slate-200 rounded" onClick={handleLogOut}>
                        <BiLogOut size={30} />
                    </button>
                </div>
            </div>

            <div className='w-full ml-[5rem] relative z-20'>
                        ...
                        allUser.map((conv, index) => {
                            ...
                            return (
                                <NavLink
                                    ...
                                    key={conv?._id}
                                    className='flex items-center gap-2 p-1 border border-transparent hover:border-primary hover:bg-gray-100 rounded-lg transition-colors duration-300 ease-in-out'
                                >
                                    ...
                                    <div className='flex-1'>
                                        <h3 className='text-lg font-semibold text-gray-800 truncate'>{conv?.userDetails?.name}</h3>
